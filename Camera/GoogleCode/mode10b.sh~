...
i2cset -f -y 0 0x15 0x81 0x05 0x10 0x04 0x41 0x01 0x04 0x00 i #values for all blue
i2cset -f -y 0 0x17 0x40 0xFF i #Set all IREF values
i2cset -f -y 0 0x17 0x00 0x80 i #Set Mode register, to allow auto increment
i2cset -f -y 0 0x17 0x81 0x05 0x50 0x40 0x10 0x41 0x00 0x00 i #values for all blue
